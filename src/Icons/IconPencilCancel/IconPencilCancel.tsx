...
export const IconPencilCancel: FC<{ width?: string | number; height?: string | number; color?: string; htmlColor?: string; strokeWidth?: string;onClick?: (event: React.MouseEvent<SVGSVGElement>) => void; style?: CSSProperties }> = ({
  width = '100%', 
  height = '100%', 
  color = 'inherit',
  htmlColor,
  ...
  return (
    ...
    >
      ...
      <path
       d="M19.5 13.5L13.5 19.5M13.5 13.5L19.5 19.5"
        stroke={finalColor}
        strokeWidth="1.5"
        strokeLinecap="round"
