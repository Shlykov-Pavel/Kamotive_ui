...
export const IconPhone: FC<{ color?: string; htmlColor?: string; strokeWidth?: string; style?: CSSProperties }> = ({
  color = 'inherit',
  htmlColor,
  strokeWidth,
  style
