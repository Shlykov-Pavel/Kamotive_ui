    ...
    <div>
        {typogrphy.map((item, index) => (
          <div key={index} className={styles['typography--wrapper']}>
            ...
            <Typography variant='Body1' style={{ fontSize: 14, lineHeight: 16, fontWeight: 400, color: '#6b7280' }}>{item.title}</Typography>
            <Typography variant='Body1' style={{ fontSize: 14, lineHeight: 16, fontWeight: 400, color: '#6b7280' }}>{item.fontSize}px</Typography>
            <Typography variant='Body1' style={{ fontSize: 14, lineHeight: 16, fontWeight: 400, color: '#6b7280' }}>'Raleway', sans-serif</Typography>
          </div>
        ))}
    </div>
  )
