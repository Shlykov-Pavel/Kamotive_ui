...
export declare const Dropdown: <T extends BaseOptions>({ options, id, label, placeholder, required, value, defaultValue, onChange, showLoadMore, loadMore, getOptionLabel, variant, size, style, className, isLeftLabel, isDivider, disabled, readOnly, isOpened, error, helperText, onOpen, onClick, onBlur, onFocus, onClose, clearable, enableAutocomplete, preserveSearchValue, onSearch, isOptionsLoading, isSearchLoading, noOptionsText, lng, multiple, limitTags, testId }: DropdownProps<T>) => React.JSX.Element;
